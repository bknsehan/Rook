...
static void cg_program(CG* g, Program* prog) {
    sb_append(&g->sb,
              ...
              "};\n"
              "#endif\n"
              "static inline int rk_win_clock_gettime(int clk_id, struct timespec* ts) {\n"
              "    (void)clk_id;\n"
              "    if (!ts) return -1;\n"
              ...
              "#define clock_gettime rk_win_clock_gettime\n"
              "#endif\n"
              "#endif\n"
              ...
              "#define __atomic_fetch_add(ptr, d, mo) _InterlockedExchangeAdd((long volatile*)(ptr), (long)(d))\n"
              "#define __atomic_fetch_sub(ptr, d, mo) _InterlockedExchangeAdd((long volatile*)(ptr), -(long)(d))\n"
              "#define __atomic_exchange_n(ptr, val, mo) _InterlockedExchange((long volatile*)(ptr), (long)(val))\n"
              "static inline int rk_win_cas(volatile void* dest, void* exp, void* des, size_t sz) {\n"
              "    if (sz == 1) {\n"
              "        char o = *(char*)exp;\n"
              "        char p = _InterlockedCompareExchange8((volatile char*)dest, *(char*)&des, o);\n"
              "        if (p == o) return 1;\n"
              "        *(char*)exp = p;\n"
              "        return 0;\n"
              "    } else if (sz == 4) {\n"
              "        long o = *(long*)exp;\n"
              "        long p = _InterlockedCompareExchange((volatile long*)dest, *(long*)&des, o);\n"
              "        if (p == o) return 1;\n"
              "        *(long*)exp = p;\n"
              "        return 0;\n"
              "    } else if (sz == 8) {\n"
              "        __int64 o = *(__int64*)exp;\n"
              "        __int64 p = _InterlockedCompareExchange64((volatile __int64*)dest, *(__int64*)&des, o);\n"
              "        if (p == o) return 1;\n"
              "        *(__int64*)exp = p;\n"
              "        return 0;\n"
              "    }\n"
              "    return 0;\n"
              "}\n"
              "#define __atomic_compare_exchange_n(ptr, exp, des, weak, sm, fm) \\\n"
              "    rk_win_cas((volatile void*)(ptr), (void*)(exp), (void*)(uintptr_t)(des), sizeof(*(ptr)))\n"
              "#endif\n"
              "#else\n"
              "#include <unistd.h>\n"
              "#endif\n\n");
