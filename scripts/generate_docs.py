...
(docs/rook-language-guide.html) for Rook & Rokade v0.5.1.
"""
...
<title>Rook Documentation &amp; Programming Foundations (v0.5.1)</title>
<style>
  :root {
    --bg: #ffffff;
    --sidebar-bg: #f8fafc;
...
<aside id="sidebar">
  <div class="sidebar-header">
    <div class="sidebar-title">
      ...
      <span class="sidebar-badge">v0.5.1</span>
    </div>
...
<main id="main">
  ...
  <footer style="margin-top: 60px; padding: 24px 0; border-top: 1px solid var(--border); color: var(--text-dim); font-size: 0.85rem; text-align: center;">
    <p>Rook Language Guide and Programming Foundations &bull; Version 0.5.1 &bull; Offline documentation</p>
  </footer>
</main>
...
def main():
    print(f"Generating documentation for Rook & Rokade v0.5.1 at {OUTPUT_FILE}...")
