...
(docs/rook-language-guide.html) for Rook & Rokade v0.5.2.
"""
...
<title>Rook Documentation &amp; Programming Foundations (v0.5.2)</title>
<style>
  :root {
    --bg: #ffffff;
    --sidebar-bg: #f8fafc;
...
<aside id="sidebar">
  <div class="sidebar-header">
    <div class="sidebar-title">
      ...
      <span class="sidebar-badge">v0.5.2</span>
    </div>
...
def main():
    print(f"Generating documentation for Rook & Rokade v0.5.2 at {OUTPUT_FILE}...")
