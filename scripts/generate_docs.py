...
(docs/rook-language-guide.html) for Rook & Rokade v0.6.0.
"""
...
<title>Rook Documentation &amp; Programming Foundations (v0.6.0)</title>
<style>
  :root {
    --bg: #ffffff;
    --sidebar-bg: #f8fafc;
...
<aside id="sidebar">
  <div class="sidebar-header">
    <div class="sidebar-title">
      ...
      <span class="sidebar-badge">v0.6.0</span>
    </div>
...
def main():
    print(f"Generating documentation for Rook & Rokade v0.6.0 at {OUTPUT_FILE}...")
